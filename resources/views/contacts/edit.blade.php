                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <select name="age">
                                    ...
                                    <option value="2" @if($contact->age == 2) selected @endif>20際～29歳</option>
                                    <option value="3" @if($contact->age == 3) selected @endif>30際～39歳</option>
                                    <option value="4" @if($contact->age == 4) selected @endif>40際～49歳</option>
                                    <option value="5" @if($contact->age == 5) selected @endif>50際～59歳</option>
